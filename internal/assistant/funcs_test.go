...
func newTestInstance() *apiv1beta1.OpenStackAssistant {
	return &apiv1beta1.OpenStackAssistant{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "test-assistant",
			Namespace: "openstack",
		},
		Spec: apiv1beta1.OpenStackAssistantSpec{
			ContainerImage: "quay.io/dprince/goose@sha256:07d7200f62bc2e8082de7a58396f8699b5f33fade1dbecc6a5b4ca03ab2f1d33",
			Provider:       apiv1beta1.ProviderGoose,
			LightspeedStack: apiv1beta1.LightspeedStackSpec{
...
func TestEntrypointScript(t *testing.T) {
	...
	g.Expect(script).To(gomega.ContainSubstring(`if [ -n "${SSL_CERT_FILE:-}" ]; then`))
...
func TestAssistantPodSpec_BasicFields(t *testing.T) {
	...
	g.Expect(spec.ServiceAccountName).To(gomega.Equal(apiv1beta1.OpenStackAssistantGooseServiceAccountName))
	...
	g.Expect(container.Image).To(gomega.Equal("quay.io/dprince/goose@sha256:07d7200f62bc2e8082de7a58396f8699b5f33fade1dbecc6a5b4ca03ab2f1d33"))
...
func TestAssistantPodSpec_GooseModel(t *testing.T) {
	g := gomega.NewWithT(t)
	instance := newTestInstance()
	instance.Spec.Goose = &apiv1beta1.GooseConfig{
