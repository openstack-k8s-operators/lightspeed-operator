...
// Package assistant provides functionality for managing OpenStack assistant resources
package assistant
...
func AssistantPodSpec(
	...
	podSpec := corev1.PodSpec{
		...
		// ServiceAccountName references the ServiceAccount this operator
		// reconciles for the goose pod, including its SCC and non-resource URL
		// RBAC wiring.
		ServiceAccountName: apiv1beta1.OpenStackAssistantGooseServiceAccountName,
		Volumes:            volumes,
...
func assistantPodVolumeMounts(instance *apiv1beta1.OpenStackAssistant, hasCombinedCA bool) []corev1.VolumeMount {
...
func assistantPodVolumes(instance *apiv1beta1.OpenStackAssistant, hasCombinedCA bool) []corev1.Volume {
